-- ============================================================================
-- BATAS PENDAFTARAN campaign ke marketplace — tanggal terakhir tim boleh
-- mendaftarkan produk ke campaign (mis. nominasi Shopee Pilih Lokal ditutup
-- 2 hari sebelum campaign mulai). Dipakai untuk URGENSI keputusan client:
-- kalau kolom ini terisi, ia menang atas aturan turunan tanggal mulai
-- (src/utils/campaignUrgency.js). Kosong = pakai aturan lama.
--
-- Diisi admin di editor campaign; dibaca client di portal & /approve.
-- Jalankan SETELAH 0062. Aman diulang. Supabase → SQL Editor.
-- ============================================================================

alter table public.campaigns
  add column if not exists registration_deadline date;

-- ── Recreate 2 RPC pembaca supaya `registrationDeadline` ikut terkirim ─────
-- Disalin utuh dari 0062 (periods, owner-bypass, portalToken, registration
-- harus tetap terbawa), hanya menambah satu field.
